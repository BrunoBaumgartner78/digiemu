...
import { Home, Package, Plus, LineChart, Wallet, User } from "lucide-react";
...
export default function DashboardLayout({ children }: { children: ReactNode }) {
    ...
    <div className={styles.wrapper}>
      ...
      <aside className={styles.sidebar}>
        ...
        <p className={styles.sidebarHint}>
          Verdiene mit deinen digitalen Produkten – DigiEmu kümmert sich um
          Zahlung &amp; Download.
        </p>
      </aside>
  ...
  <div className={styles.mobileShell}>
    <div className={styles.mobilePill}>
      {/* Floating Plus */}
      <Link href="/dashboard/new" className={styles.mobileFab} aria-label="Neues Produkt">
      ...
      <nav className={styles.mobileRow} aria-label="Dashboard Navigation">
        ...
        <Link href="/dashboard/products/top" className={styles.mobileItem} aria-label="Top-Produkte">
          <LineChart size={18} className={styles.mobileIcon} />
        </Link>

        <Link href="/dashboard/earnings" className={styles.mobileItem} aria-label="Einnahmen">
          <LineChart size={18} className={styles.mobileIcon} />
        </Link>

        <Link href="/dashboard/payouts" className={styles.mobileItem} aria-label="Auszahlungen">
