        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-6">
          <div className="space-y-4">
            <div>
              ...
              <input className="input-neu w-full" value={title} onChange={(_e) => setTitle(_e.target.value)} />
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div>
                ...
                <input className="input-neu w-full" value={category} onChange={(_e) => setCategory(_e.target.value)} />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(_e) => setModerationNote(_e.target.value)}
              />
            </div>
          </div>
          ...
          <aside className="space-y-4">
            <div className="rounded-3xl border border-[var(--neo-card-border)] bg-[var(--neo-card-bg-soft)] shadow-[var(--neo-card-shadow-soft)] p-4">
              ...
              <select
                ...
                value={status}
                onChange={(_e) => {
                  const v = _e.target.value as InitialProduct["status"];
                  setStatus(v);
              ...
              <div className="mt-3 flex items-center gap-2">
                <input
                  ...
                  onChange={(_e) => setIsActive(_e.target.checked)}
                />
            ...
            <div className="rounded-3xl border border-[var(--neo-card-border)] bg-[var(--neo-card-bg-soft)] shadow-[var(--neo-card-shadow-soft)] p-4">
              ...
              <input className="input-neu w-full" value={thumbnail} onChange={(_e) => setThumbnail(_e.target.value)} />
              ...
              <div className="mt-3 rounded-2xl overflow-hidden border border-[var(--neo-card-border)] bg-[var(--bg-soft)]">
                ...
                <img
                  ...
                  decoding="async"
                  onError={(_e) => {
                    _e.currentTarget.src = "/fallback-thumbnail.svg";
                  }}
                />
              </div>
